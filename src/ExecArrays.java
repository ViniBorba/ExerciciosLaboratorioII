...
public class ExecArrays {
	...
	public static void main(String[] args) {
		...
		//MetodosArrays testarMetodosArray = new MetodosArrays(); Se usar metodos static n�o precisa instanciar pra chamar o metodo
		...
		//array de objetos n�o basta ser instanciada, tamb�m tem que ser popupada por ojetos do tipo declarado
